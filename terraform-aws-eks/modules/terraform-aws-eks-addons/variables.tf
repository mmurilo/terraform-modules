...
variable "enable_akuity" {
  description = "Enable Akuity ArgoCD Kubernetes add-on"
  type        = bool
  default     = false
}

variable "akuity" {
  description = "Akuity add-on configuration values"
  type        = any
  default     = {}
}
...
variable "enable_gar_registry_secret" {
  description = "Create Google Artifact Registry connection secret"
  type        = bool
  default     = false
}

variable "gar_registry" {
  description = "Google Artifact Registry add-on configuration values"
  type        = any
  default     = {}
}