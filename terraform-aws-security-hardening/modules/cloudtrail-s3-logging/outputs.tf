...
output "cloudwatch_logs_policy_arn" {
  description = "The ARN of the managed IAM policy for CloudWatch Logs delivery (CIS 1.15 compliant)"
  value       = try(aws_iam_policy.cloudtrail_cloudwatch_logs[0].arn, null)
}
