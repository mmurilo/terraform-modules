...
| <a name="input_enable_cloudwatch_logs"></a> [enable\_cloudwatch\_logs](#input\_enable\_cloudwatch\_logs) | Whether to enable CloudWatch Logs for CloudTrail | `bool` | `true` | no |
...
| <a name="output_cloudwatch_logs_policy_arn"></a> [cloudwatch\_logs\_policy\_arn](#output\_cloudwatch\_logs\_policy\_arn) | The ARN of the managed IAM policy for CloudWatch Logs delivery (CIS 1.15 compliant) |
