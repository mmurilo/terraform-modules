...
resource "aws_s3_bucket" "cloudtrail" {
  ...
  bucket        = var.s3_bucket_name_prefix != null ? "${var.s3_bucket_name_prefix}-cloudtrail-logs-${var.log_archive_account_id}-${random_string.bucket_suffix[0].result}" : "cloudtrail-logs-${var.log_archive_account_id}-${random_string.bucket_suffix[0].result}"
...
resource "aws_s3_bucket" "access_logs" {
  ...
  bucket        = var.s3_bucket_name_prefix != null ? "${var.s3_bucket_name_prefix}-cloudtrail-access-logs-${var.log_archive_account_id}-${random_string.bucket_suffix[0].result}" : "cloudtrail-access-logs-${var.log_archive_account_id}-${random_string.bucket_suffix[0].result}"
